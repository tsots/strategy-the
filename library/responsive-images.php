...
add_image_size( 'katalist-small', 640, 200, true ); // name, width, height, crop
add_image_size( 'katalist-medium', 640, 400, true );
add_image_size( 'katalist-large', 1440, 400, true );
add_image_size( 'katalist-xlarge', 1920, 400, true );
